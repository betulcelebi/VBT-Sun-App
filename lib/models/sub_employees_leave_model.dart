class SubEmployeesLeaveResponse {
  String? refreshToken;
  String? token;
  Data? data;

  SubEmployeesLeaveResponse({this.refreshToken, this.token, this.data});

  SubEmployeesLeaveResponse.fromJson(Map<String, dynamic> json) {
