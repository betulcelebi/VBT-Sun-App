...
//
//     final myRequestDetailResponse = myRequestDetailResponseFromJson(jsonString);

import 'dart:convert';

MyRequestDetailResponse myRequestDetailResponseFromJson(String str) =>
    MyRequestDetailResponse.fromJson(json.decode(str));

String myRequestDetailResponseToJson(MyRequestDetailResponse data) =>
    json.encode(data.toJson());

class MyRequestDetailResponse {
  ...
  factory MyRequestDetailResponse.fromJson(Map<String, dynamic> json) =>
      MyRequestDetailResponse(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        requestDetailKeyValue: json["REQUEST_DETAIL_KEY_VALUE"] == null
            ? []
            : List<RequestDetailKeyValue>.from(json["REQUEST_DETAIL_KEY_VALUE"]
  ...
  Map<String, dynamic> toJson() => {
        ...
        "REQUEST_DETAIL_KEY_VALUE": requestDetailKeyValue == null
            ? []
            : List<dynamic>.from(requestDetailKeyValue!.map((x) => x.toJson())),
