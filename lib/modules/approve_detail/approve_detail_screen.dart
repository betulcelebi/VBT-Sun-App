              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    child: GetBuilder(
                        init:
                            ApproveDetailController(idMaster: widget.idMaster),
                        builder: (controller) {
                          if (controller.approveDetailResponse == null) {
                            return const Center(
                                                        ...
                                                        Text(
                                                          controller.approveDetailResponse ==
                                                              ...
                                                              : DateFormat(
                                                                  ...
                                                                  DateTime
                                                                      .parse(
                                                                    controller.approveDetailResponse?["Data"]["HISTORY"][0]
                                                                            [
                                                                            "CONFIRM_DATE"] ??
                                                                        DateTime.now()
                                                                            .toString(),
