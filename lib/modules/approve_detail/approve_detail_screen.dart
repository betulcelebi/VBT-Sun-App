...
class ApproveDetailScreen extends GetView<ApproveDetailController> {
  const ApproveDetailScreen({super.key});
          ...
          Expanded(
            child: Container(
              ...
              child: SingleChildScrollView(
                child: Padding(
                  padding:
                      EdgeInsets.symmetric(vertical: 3.h, horizontal: 2.8.h),
                  child: Column(
