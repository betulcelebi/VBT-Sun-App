            ...
            child: Row(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: Text("İşlerim",style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 20.sp,color: Colors.white)),),
                ),
                Padding(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text("İş No",style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 16.sp,color: Colors.grey.shade400)),),
                                SizedBox(width: 60.w,),
                               Icon(Icons.work_history_outlined,size: 4.5.h,color: Color(0xff567DF4),)
                               
                               
                              ],
                            ),
                            Text("13",style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 18.sp)),),
                            ...
                            Text("Talep eden verisi yazmıyor",style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 18.sp)),),
                            Text("Durumu",style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 16.sp,color: Colors.grey.shade400)),),
                            Text("Bekliyor",style: GoogleFonts.poppins(textStyle: TextStyle(fontSize: 18.sp)),),
